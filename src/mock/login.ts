/**
 * @description mockjs 第三方库与 el-upload 有冲突 , 具体可见 https://github.com/nuysoft/Mock/issues/244
 */
const Mock = {
	login: {
		data: {
	...
	menuList: {
		data: [
			...
			},
			{
				...
				children: [
					{
						path: '/storeHouse/InventoryInquiry',
						name: 'InventoryInquiry',
						component: '/storeHouse/InventoryInquiry/index',
						meta: {
							icon: 'Menu',
							title: '库存查询',
							isLink: '',
					...
					{
						path: '/storeHouse/warHouse',
						name: 'warHouse',
						component: '/storeHouse/warHouse/index',
						meta: {
							icon: 'Menu',
							title: '入库',
							isLink: '',
					...
					{
						path: '/storeHouse/OutWarHouse',
						name: 'OutWarHouse',
						component: '/storeHouse/OutWarHouse/index',
						meta: {
							icon: 'Menu',
							title: '出库',
							isLink: '',
